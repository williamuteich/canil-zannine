...
export function Banner() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-linear-to-br from-[#FFF7F0] via-[#F9D7EB] to-[#B6F1FF]">
      ...
      <div className="relative z-10 w-full px-8 pt-28 pb-24 sm:pt-32 sm:pb-28 lg:pt-36 lg:pb-[calc(12rem+6vh)] xl:pt-40 xl:pb-[calc(14rem+8vh)] 2xl:pt-44 2xl:pb-[calc(16rem+2vh)]">
        <motion.div
        ...
        >
          ...
          >
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] hover:bg-[#1EB656] text-white text-md font-semibold px-8 py-3 sm:px-10 sm:py-3 shadow-xl shadow-[#25D366]/40 transition-all duration-200 hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366]"
            >
