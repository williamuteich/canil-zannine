                ...
                {success ? (
                  <div className="text-center space-y-6">
                    ...
                    <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight text-gray-900">
                      <span className="bg-linear-to-r from-[#b8860b] to-[#d35836] bg-clip-text text-transparent">Email enviado!</span>
                    </h1>
                    ...
                    <div className="pt-4">
                      <Link
                        href="/login"
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-[#b8860b] to-[#d35836] text-white font-semibold px-6 py-3 shadow-lg hover:scale-[1.01] transition-all duration-300"
                      >
                  ...
                  <>
                    <div className="text-center space-y-2 mb-6 sm:mb-8">
                      <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight text-gray-900">
                        <span className="bg-linear-to-r from-[#b8860b] to-[#d35836] bg-clip-text text-transparent">Recuperar Senha</span>
                      </h1>
                      <p className="text-[#57534e] text-sm sm:text-base">
